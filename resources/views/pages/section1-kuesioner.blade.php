                ...
                <div class="col-lg-8" data-aos="fade-up">
                    <div class="thankyou-card">
                        ...
                        <h4 class="mb-4 text-accent">
                            Kuesioner Bagian 1 Telah Berhasil Diselesaikan
                        </h4>
                        
                        <p class="lead mb-4">
                            Terima kasih atas partisipasi Anda dalam mengisi kuesioner Tracer Study UAD Bagian 1. Kontribusi Anda sangat berharga untuk pengembangan almamater.
                        </p>
                        ...
                        <div class="features-section">
                                ...
                                <div class="feature-card unlocked" data-aos="fade-right" data-aos-delay="150">
                                    <div class="feature-header">
                                        ...
                                        <div class="feature-title">
                                            <h5 class="fw-bold mb-1">Leaderboard & Points</h5>
                                    ...
                                    <p class="feature-description">
                                        Lihat peringkat Anda di antara alumni dan kumpulkan points untuk mendapatkan rewards menarik.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="features-grid">
                                <div class="feature-card locked" data-aos="fade-right" data-aos-delay="200">
                                    <div class="feature-header">
                                        <div class="feature-icon">
                                            <i class="fas fa-comments"></i>
                                        </div>
                                        <div class="feature-title">
                                            <h5 class="fw-bold mb-1">Forum Diskusi</h5>
                                            <span class="feature-badge locked">
                                                <i class="fas fa-lock me-1"></i> Kuesioner 2
                                            </span>
                                        </div>
                                    </div>
                                    <p class="feature-description">
                                        Diskusi dengan ribuan alumni, sharing pengalaman karir, dan membangun jaringan profesional.
                                    </p>
                                </div>
                                
                                <div class="feature-card locked" data-aos="fade-left" data-aos-delay="250">
                                    <div class="feature-header">
                                        <div class="feature-icon">
                                        ...
                                        <div class="feature-title">
                                            ...
                                            <span class="feature-badge locked">
                                                <i class="fas fa-lock me-1"></i> Kuesioner 3
                                            </span>
                                        </div>
                                    </div>
                                    <p class="feature-description">
                                ...
                                <div class="feature-card locked" data-aos="fade-right" data-aos-delay="300">
                                    <div class="feature-header">
                                        <div class="feature-icon">
                        ...
                        <div class="next-section" data-aos="zoom-in">
                            ...
                            <p class="mb-4">
                                Lanjutkan kuesioner bagian 2 untuk membuka fitur <strong>Forum Diskusi</strong> dan mengumpulkan lebih banyak points.
                            </p>
                        </div>
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-center gap-3 mt-4">
                            ...
                            <button class="btn btn-next btn-custom" id="nextQuestionnaireBtn" data-aos="fade-left" data-aos-delay="350">
                                <i class="fas fa-arrow-right me-2"></i> Lanjut ke Kuesioner Bagian 2
                            </button>
                        </div>
