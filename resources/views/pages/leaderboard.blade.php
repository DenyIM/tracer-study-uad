<x-app-layout>
    ...
    <section class="leaderboard-header">
        <div class="container">
            ...
            <p class="lead mb-4" data-aos="fade-up" data-aos-delay="100">Kompetisi sehat untuk berkontribusi bagi almamater dan dapatkan rewards eksklusif!</p>
    ...
    <div class="main-content">
        <div class="container py-5">
            <ul class="nav nav-tabs nav-tabs-custom" id="leaderboardTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="submit-tab" data-bs-toggle="tab" data-bs-target="#submit" type="button" role="tab">
                        <i class="fas fa-paper-plane me-2"></i>Kirim Informasi
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="leaderboardTabsContent">
                <div class="tab-pane fade show active" id="leaderboard" role="tabpanel">
                    ...
                    <div class="leaderboard-table" data-aos="fade-up">
                ...
                <div class="tab-pane fade" id="submit" role="tabpanel">
                    <div class="points-info-card" data-aos="fade-up">
                        ...
                        <div class="points-item">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted">Dapatkan <strong>2,000 points</strong> per informasi yang disetujui admin</p>
                            </div>
                        </div>
                        <div class="points-item">
                            <div class="points-icon">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted">Dapatkan <strong>3,000 points</strong> per lowongan yang disetujui admin</p>
                            </div>
                        </div>
                        <div class="points-item">
                            <div class="points-icon">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted">Dapatkan <strong>5,000 points</strong> per kuesioner yang diselesaikan</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="nav nav-pills mb-4" id="submitTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="forum-tab" data-bs-toggle="pill" data-bs-target="#forum" type="button">
                            ...
                            <div class="form-section" data-aos="fade-up">
                                ...
                                <form id="forumForm">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Contoh: Seminar Digital Marketing 2024" required>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label class="form-label">Deskripsi Lengkap</label>
                                        <textarea class="form-control form-textarea" placeholder="Jelaskan secara detail tentang informasi yang ingin Anda bagikan..." required></textarea>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Contoh: Zoom Meeting, Gedung A UAD, dll">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nama dan nomor/email kontak">
                                    </div>
                            ...
                            <div class="form-section" data-aos="fade-up">
                                ...
                                <form id="jobForm">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Contoh: PT. Teknologi Indonesia" required>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label class="form-label">Posisi yang Dibutuhkan</label>
                                        <input type="text" class="form-control" placeholder="Contoh: Software Engineer" required>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label class="form-label">Lokasi Kerja</label>
                                        <input type="text" class="form-control" placeholder="Contoh: Jakarta Selatan" required>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <label class="form-label">Deskripsi Pekerjaan</label>
                                        <textarea class="form-control form-textarea" placeholder="Jelaskan tanggung jawab dan deskripsi pekerjaan..." required></textarea>
                                    </div>
