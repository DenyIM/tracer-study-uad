...
<body>
                ...
                <div class="col-lg-8" data-aos="fade-up">
                    <div class="thankyou-card">
                        ...
                        <h4 class="mb-4 text-accent">
                            Kuesioner Bagian 2 Telah Berhasil Diselesaikan
                        </h4>
                        
                        <p class="lead mb-4">
                            Terima kasih atas partisipasi Anda dalam mengisi kuesioner Tracer Study UAD Bagian 2. Kontribusi Anda sangat berharga untuk pengembangan almamater.
                        </p>
                        ...
                        <div class="features-section">
                            ...
                            <div class="features-grid">
                                <div class="feature-card locked" data-aos="fade-right" data-aos-delay="250">
                                    <div class="feature-header">
                                        <div class="feature-icon">
                        ...
                        <div class="next-section" data-aos="zoom-in">
                            ...
                            <p class="mb-4">
                                Lanjutkan kuesioner bagian 3 untuk membuka fitur <strong>Konsultasi Mentor</strong> dan mengumpulkan lebih banyak points.
                            </p>
                        </div>
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-center gap-3 mt-4">
                            ...
                            <button class="btn btn-next btn-custom" id="nextQuestionnaireBtn" data-aos="fade-left" data-aos-delay="350">
                                <i class="fas fa-arrow-right me-2"></i> Lanjut ke Kuesioner Bagian 3
                            </button>
                        </div>
    ...
    <script>
        ...
        document.getElementById('nextQuestionnaireBtn').addEventListener('click', function() {
            ...
            setTimeout(() => {
                window.location.href = '/next-section3';
            }, 1500);
        });
