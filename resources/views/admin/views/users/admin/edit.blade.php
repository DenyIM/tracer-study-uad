...
<div class="card dashboard-card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.views.admins.update', $admin->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('job_title') is-invalid @enderror" 
                           name="job_title" value="{{ old('job_title', $admin->job_title) }}" required>
                    @error('job_title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.views.admins.index') }}" class="btn btn-secondary me-2">
