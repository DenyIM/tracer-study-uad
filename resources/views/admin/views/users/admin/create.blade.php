            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="mb-0">
                        ...
                        Hanya <strong>Super Admin</strong> dan <strong>Admin Sistem</strong> yang dapat menambah admin.
                        <br>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card dashboard-card">
                    <div class="card-header">
                        ...
                        <p class="text-muted mb-0 small">Hanya Super Admin dan Admin Sistem yang dapat menambah
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('job_title') is-invalid @enderror" name="job_title"
                                        ...
                                        <option value="Super Admin"
                                            {{ old('job_title') == 'Super Admin' ? 'selected' : '' }}>
                                            Super Admin
                                        </option>
                                        <option value="Admin Sistem"
                                            {{ old('job_title') == 'Admin Sistem' ? 'selected' : '' }}>
                                            Admin Sistem
                                        </option>
                                        ...
                                        <option value="Admin Alumni"
                                            {{ old('job_title') == 'Admin Alumni' ? 'selected' : '' }}>
                                            Admin Alumni
                                        </option>
                                    ...
                                    <small class="form-text text-muted">
                                        <span class="fw-medium text-primary">Super Admin & Admin Sistem:</span> Dapat
                                        mengelola semua data admin<br>
                                        <span class="fw-medium text-secondary">Admin lainnya:</span> Hanya dapat melihat
                                        data admin
                                    </small>
                                </div>
