...
@section('title', 'Forum Submissions')
@section('page-title', 'Forum Submissions Management')
@section('page-subtitle', 'Review and approve forum information submissions')
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">Forum Submissions</h5>
                    <small class="text-muted">Manage alumni forum information submissions</small>
                </div>
                <div class="d-flex gap-2">
                    ...
                    @if ($status == 'pending')
                        <button class="btn btn-success" onclick="bulkApprove('forum')" id="bulkApproveBtn" disabled>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small class="text-muted">
                                    <i class="fas fa-tag me-1"></i>{{ ucfirst($submission->category) }}
                                </small>
                                @if ($submission->date_time)
                                    <br>
                                    <small class="text-muted">
                                        <i class="fas fa-calendar me-1"></i>
                                        {{ date('d M Y', strtotime($submission->date_time)) }}
                                    </small>
                                @endif
                            </td>
                            <td>
                            ...
                            <td class="action-buttons">
                                ...
                                @if ($submission->status != 'pending')
                                    <button onclick="deleteSubmission('forum', {{ $submission->id }})"
                        ...
                        <tr>
                            <td colspan="{{ $status == 'pending' ? 7 : 6 }}" class="text-center py-4">
                                ...
                                @elseif($status == 'approved')
                                    ...
                                    <p class="text-muted mb-0">No approved forum submissions</p>
                                @else
                                    <i class="fas fa-times-circle fa-2x text-danger mb-3"></i>
                                    <p class="text-muted mb-0">No rejected forum submissions</p>
                                @endif
                            </td>
                        </tr>
                    @endforelse
