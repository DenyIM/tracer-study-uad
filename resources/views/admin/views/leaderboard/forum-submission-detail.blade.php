...
@section('title', 'Forum Submission Detail')
@section('page-title', 'Forum Submission Details')
@section('page-subtitle', 'Review submission information')
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.leaderboard.forum.submissions') }}?status={{ $submission->status }}"
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="submission-detail-card mb-4">
                <h5 class="mb-4"><i class="fas fa-info-circle text-primary me-2"></i>Submission Information</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="detail-value">
                            <span class="badge bg-primary">{{ ucfirst($submission->category) }}</span>
                        </div>
                    </div>
                    ...
                    @if ($submission->date_time)
                        <div class="col-md-6 mb-3">
                            <div class="detail-label">Date & Time</div>
                            <div class="detail-value">
                                <i class="fas fa-calendar me-2"></i>
                                {{ date('d F Y, H:i', strtotime($submission->date_time)) }}
                            </div>
                        </div>
                    @endif
                    ...
                    @if ($submission->location)
                        <div class="col-md-6 mb-3">
                            <div class="detail-label">Location / Platform</div>
                            <div class="detail-value">
            ...
            @if ($submission->status == 'pending')
                <div class="submission-detail-card">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button onclick="rejectSubmission('forum', {{ $submission->id }})" class="btn btn-reject btn-lg">
                    ...
                    <div class="mt-3">
                        <small class="text-muted">
                            ...
                            Approving will award 2000 points to the alumni
                        </small>
                    </div>
                </div>
            @else
                <div class="submission-detail-card">
                    ...
                    <div class="d-grid gap-2">
                        <button onclick="deleteSubmission('forum', {{ $submission->id }})" class="btn btn-danger btn-lg">
