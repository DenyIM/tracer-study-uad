        ...
        <div class="col-md-3 mb-4">
            <div class="card dashboard-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-3">{{ $verifiedAlumniCount }}</h3>
        ...
        <div class="col-md-3 mb-4">
            <div class="card dashboard-card">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-3">{{ $alumniCount - $verifiedAlumniCount }}</h3>
            ...
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('admin.views.users.admin.index') }}" class="btn btn-info w-100">
                                <i class="bi bi-shield-check me-2"></i> Kelola Admin
                            </a>
                        </div>
                        <div class="col-md-4 mb-3">
                            <a href="{{ route('admin.views.users.admin.create') }}" class="btn btn-success w-100">
