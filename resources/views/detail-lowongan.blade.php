            ...
            <div class="col-lg-8">
                ...
                <div class="job-detail-card" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="card-body-custom">
                        <p class="lead">Kami mencari Software Engineer yang passionate tentang teknologi untuk bergabung dengan tim pengembangan produk inovatif kami.</p>
                ...
                <div class="job-detail-card" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="card-body-custom">
                        ...
                        <ul class="requirements-list">
                            <li>Lulusan S1 Teknik Informatika, Ilmu Komputer, atau bidang terkait</li>
                    ...
                    <div class="card-body-custom">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <p class="mb-3">Perusahaan teknologi yang berfokus pada pengembangan solusi digital untuk UMKM Indonesia. Didirikan pada tahun 2018, kami telah membantu lebih dari 500 UMKM dalam transformasi digital.</p>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <p><a href="https://majujaya-tech.com" target="_blank">majujaya-tech.com</a></p>
                                    </div>
                                    <div class="col-sm-6">
                            ...
                            <div class="col-md-4">
                                <div class="text-center">
                                    <div class="company-logo-large mx-auto mb-3" style="background: var(--primary-blue); color: white;">MJ</div>
                                    <a href="https://majujaya-tech.com" target="_blank" class="btn btn-outline-primary btn-sm">
                    ...
                    <div class="card-body-custom">
                        ...
                        <div class="alert alert-info">
                            <small>
                                ...
                                <strong>Tips:</strong> Sertakan link ke project dalam portfolio untuk meningkatkan peluang Anda.
                            </small>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    <a href="https://majujaya-tech.com/careers/apply/software-engineer" target="_blank" class="btn-apply me-3">
